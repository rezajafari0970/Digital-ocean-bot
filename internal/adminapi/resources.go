...
func (s *Server) accounts(w http.ResponseWriter, r *http.Request) {
	...
	for rows.Next() {
		...
		canCreate := enabled && dropletLimit > providerDroplets && runtimeStatus == "READY"
		...
		if !enabled {
			...
			canCreate = false
		} else if runtimeStatus == "PROVIDER_BLOCKED" && providerState == "active" {
